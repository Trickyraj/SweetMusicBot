...
import config
from SweetXMusic import Carbon, YouTube, app
from SweetXMusic.core.call import SweetX
from SweetXMusic.misc import db
from SweetXMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from SweetXMusic.utils.exceptions import AssistantErr
from SweetXMusic.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from SweetXMusic.utils.inline.playlist import close_markup
from SweetXMusic.utils.pastebin import SweetXbin
from SweetXMusic.utils.stream.queue import put_queue, put_queue_index
from SweetXMusic.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await SweetX.force_stop_stream(chat_id)
