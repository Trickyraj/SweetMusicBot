...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("the_love_chat")
                await self.one.join_chat("Sweet_X_Music")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("the_love_chat")
                await self.two.join_chat("Sweet_X_Music")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("the_love_chat")
                await self.three.join_chat("Sweet_X_Music")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("the_love_chat")
                await self.four.join_chat("Sweet_X_Music")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("the_love_chat")
                await self.five.join_chat("Sweet_X_Music")
            except:
                pass
            assistants.append(5)
