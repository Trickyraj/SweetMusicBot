...
from SweetXMusic.utils.database import get_authuser_names, get_cmode
from SweetXMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from SweetXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await SweetX.stop_stream(message.chat.id)
    except:
        pass
