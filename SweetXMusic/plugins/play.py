...
from SweetXMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from SweetXMusic.core.call import SweetX
from SweetXMusic.utils import seconds_to_min, time_to_seconds
from SweetXMusic.utils.channelplay import get_channeplayCB
from SweetXMusic.utils.database import is_video_allowed
from SweetXMusic.utils.decorators.language import languageCB
from SweetXMusic.utils.decorators.play import PlayWrapper
from SweetXMusic.utils.formatters import formats
from SweetXMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from SweetXMusic.utils.inline.playlist import botplaylist_markup
from SweetXMusic.utils.logger import play_logs
from SweetXMusic.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("SweetXymousAdmin") & ~BANNED_USERS
)
async def SweetXymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("SweetXPlaylists") & ~BANNED_USERS
)
@languageCB
